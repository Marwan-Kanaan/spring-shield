...
> your own user store, JWT bearer token validation, permission
...
For authentication, publish a [SecurityUserProvider](#username-and-password) or configure
[JWT bearer tokens](#jwt-bearer-tokens). The chain also keeps
